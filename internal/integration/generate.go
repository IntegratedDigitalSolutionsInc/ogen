...
//go:generate go run ../../cmd/ogen -v --clean --config _config/test_operation_groups.yml --target test_operation_groups ../../_testdata/positive/test_operation_groups.yml
